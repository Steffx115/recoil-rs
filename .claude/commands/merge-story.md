...
6. **Transition Jira to "Done"** — `mcp__mcp-atlassian__jira_transition_issue` with transition_id `31`.
7. **Add a comment** to the Jira issue summarizing what was implemented.
